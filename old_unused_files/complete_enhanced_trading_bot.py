#!/usr/bin/env python3
"""
ZoneSync FX Bot - Complete Enhanced Version
Integrates original strategy with stability fixes, H4 bias, and Telegram notifications
"""
...
class TelegramNotifier:
    ...
    def send_trading_alert(self, symbol: str, zone_type: str, entry: float,
                          stop: float, target: float, rr: float, bias_info: str) -> bool:
...
class ZoneDetector:
    """Original zone detection logic enhanced"""
    ...
    def find_zones(self, symbol: str, h1_df: pd.DataFrame, d1_bias: str, h4_bias: Dict[str, Any]) -> List[Dict[str, Any]]:
        """Find zones using original logic with H4 filtering"""
            ...
            try:
                ...
                for zone in zones:
                    ...
                    if success:
                        ...
                        signals_sent += 1
                        logger.info(f"Alert sent for {symbol} {zone['type']} zone")
